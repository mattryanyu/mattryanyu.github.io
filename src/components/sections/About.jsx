...
export default function About({ resume }) {
  return (
    <div id="about" className="relative isolate overflow-hidden bg-base-200 px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0 scroll-mt-14">
      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid-cols-2 lg:items-start lg:gap-y-10">
        ...
        <div className="p-6 lg:p-4 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1">
          <Reveal>
