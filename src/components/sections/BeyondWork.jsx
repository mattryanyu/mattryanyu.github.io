  ...
  return (
    <section id="beyond-work" className="relative isolate overflow-hidden bg-base-300 px-6 py-16 sm:py-20 lg:px-8 scroll-mt-14">
      ...
      <div className="mx-auto max-w-3xl">
        <Reveal>
          <h2 className="mb-6 text-3xl font-bold tracking-tight text-base-content">Beyond Work</h2>
            ...
            {resume.interests.map((item, i) => (
              <div key={i} className="card bg-base-300 border border-base-content/10">
                <div className="card-body p-5 gap-2 text-left">
                  ...
                  <p className="text-base font-bold text-base-content">{item.title}</p>
                  <p className="text-base text-base-content/60 leading-snug">{item.description}</p>
                </div>
              </div>
            ))}
          </div>
